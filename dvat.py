#!/usr/bin/env python3
# ============================================================
# DVAT â€“ Defensive Vulnerability Assessment Tool
# Author  : Balaji Sangana
# Version : 3.3.0
# Mode    : Blue Team / Defensive Security
# ============================================================
# âš  Authorized testing only
# ============================================================
...
=============Â°==============================================
  ...
  â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•—â•šâ•â•â–ˆâ–ˆâ•”â•â•â•
  â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘
  â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘â•šâ–ˆâ–ˆâ•— â–ˆâ–ˆâ•”â•â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘
  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•”â• â•šâ–ˆâ–ˆâ–ˆâ–ˆâ•”â• â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘
  â•šâ•â•â•â•â•â•   â•šâ•â•â•â•  â•šâ•â•  â•šâ•â•   â•šâ•â•
============================================================
DVAT â€“ Defensive Domain & URL Testing Tool
Version : {VERSION} 
Author  : Balaji Sangana
 Mode   : Blue-Team / Defensive Security
------------------------------------------------------------
 âš  Authorized testing only. Misuse is illegal.
------------------------------------------------------------
""")
...
def plot_timeline(lat, name):
    ...
    plt.title(f"Latency Timeline â€“ {name}")
    plt.grid(True)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DVAT â€“ Defensive URL / Domain Vulnerability Assessment Tool",
    ...
    for i, url in enumerate(targets, 1):
        ...
        if dom in ["RATE_LIMIT", "WAF_BLOCK", "TIMEOUT"]:
            ...
            print("[âŒ] POTENTIALLY VULNERABLE")
